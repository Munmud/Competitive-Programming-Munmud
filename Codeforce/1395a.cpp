...
bool check(int red , int green , int blue , int white)
{
    if (red%2 + green%2 + blue%2 + white%2 >1) return false ;
    return true ;
}
...
int main ()
{
   //freopen("E:/Programming/input.txt", "r" , stdin );
    ...
    FORAB(tes,1,testCase){
        ...
        if (check(red , green , blue , white)) cout << "Yes" << endl ;
        else if ( red && green && blue && check(red-1 , green-1 , blue-1 , white+3))
            cout << "Yes" << endl ;
        else cout << "No" << endl ;
