...
int main ()
{
   //freopen("E:/Programming/input.txt", "r" , stdin );
    ...
    FORAB(tes,1,testCase){
        int n ; string s , str ;
        vector <string> captain ,woman_children ,rat , man  ;
        cin >> n ;
        cin.ignore() ;
        FORN(i,n)
        {
            ...
            ss >> str ;
            ss >> s ;
            if (s == "captain") captain.pb(str) ;
            else if (s == "woman" || s=="child") woman_children.pb(str) ;
            else if (s == "rat") rat.pb(str) ;
            else man.pb(str) ;
        }
        for (auto i : rat) cout << i << endl ;
        for (auto i : woman_children) cout << i << endl ;
        for (auto i : man) cout << i << endl ;
        for (auto i : captain) cout << i << endl ;
