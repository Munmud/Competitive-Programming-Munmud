...
// * if we find '*' on the way. we have to continue form other '*'
...
// * start from 'P'. when you get a portal ('*') with distance d, mark all other the portal d+2 and all other portal d+1. also push them in the queue. it will be wise if you keep track on the min distance for these portal. So that you dont have to count all of them agian and again .
